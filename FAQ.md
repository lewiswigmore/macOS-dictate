...
By design. dictate is a self-hosted tool, not a marketplace product. You clone the repo, run `install.sh`, and you own the install. If you want a `.app` bundle for your own use, the [Build .app](./docs/build-app.md) guide walks through it; signed and notarised distribution is intentionally out of scope.

## Can I contribute?

Yes. See [CONTRIBUTING.md](./CONTRIBUTING.md) for the contribution workflow.

## How do I report a security issue?

Use GitHub Security Advisories. See [SECURITY.md](./SECURITY.md) for details.
